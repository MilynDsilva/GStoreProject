   ...
   <div class ="loginbox">
      ...
      <form action="verify.php" method="POST">
        ...
        <div>
          ...
          <button type="submit" name="btn_submit" class="btn btn-danger btn-circle btn-xl"><b>Submit</b></button>
...
<!-- jQuery Version 1.11.1 -->
    ...
    <div class ="reg">
     ...
     <div class ="help">
          ...
          <button type="button" class="btn btn-danger btn-circle btn-xls"onclick="window.location.href='adminlogin.php';"><b>Admin</b></button>
